...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Checkout working repository before git pull
    |
    | Use to discard local changes and prevent conflicts while pulling
    |
    */
    ...
    */
    ...
    'maintenance_mode' => env('DEPLOY_MAINTENANCE_MODE', false),
    ...
    */
    ...
    'fire_event' => env('DEPLOY_FIRE_EVENT', true),
    ...
    */
    ...
    'secret' => env('DEPLOY_SECRET', true),

    /*
     * plain|hmac
     */
    'secret_type' => env('DEPLOY_SECRET_TYPE', 'plain'),

    /*
     * X-Gitlab-Token|X-Hub-Signature
     */
    'secret_header' =>  env('DEPLOY_SECRET_HEADER', 'X-Gitlab-Token'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Middleware for webhook route
    |--------------------------------------------------------------------------
    |
    | Optionaly specify Middleware for webhook route
    |
    */
